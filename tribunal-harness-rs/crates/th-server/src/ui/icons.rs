...
pub const CIRCLE_ALERT: Icon = Icon {
    name: "circle-alert",
    paths: r#"<circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/>"#,
};
pub const CIRCLE_X: Icon = Icon {
    name: "circle-x",
    paths: r#"<circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/>"#,
};
...
pub const CALENDAR: Icon = Icon {
    name: "calendar",
    paths: r#"<path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/>"#,
};
...
pub const GAVEL: Icon = Icon {
    name: "gavel",
    paths: r#"<path d="m14.5 12.5-8 8a2.119 2.119 0 1 1-3-3l8-8"/><path d="m16 16 6-6"/><path d="m8 8 6-6"/><path d="m9 7 8 8"/><path d="m21 11-8-8"/>"#,
};
